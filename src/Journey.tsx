    ...
    <div className="journey-main-con">
        <ul className='journey-header-con' >
            ...
            <li className='journey-header-rightcon'>
                <img src={`${BASE_URL}planenobg.png`} className={`plane ${Moveplane}`} ></img>
            ...
            <li className='journey-rightbody-content-con' >
                <div className='abs-TnearPlane-con'>
                        <div className={`abs-TnearPlane-subcon ${CtrltoolNP}`} >
                            <div className='TnearPlane-child-extraleft' ><img id='logo-Nearplane' src={`${BASE_URL}htmlnobg.png`} /></div>
                            <div className='TnearPlane-child' ><img  id='logo-Nearplane' src={`${BASE_URL}cssnobg.png`} /></div>
                            <div className='TnearPlane-child'><img  id='logo-Nearplane' src={`${BASE_URL}javascript-no-bg.png`} /></div>
                            <div className='TnearPlane-child' ><img  id='logo-Nearplane' src={`${BASE_URL}reactnobg.png`} /></div>
                            <div className='TnearPlane-child' ><img  id='logo-Nearplane' src={`${BASE_URL}nextjs-no-bg.png`} /></div>
                            <div className='TnearPlane-child-extraright' ><img id='logo-Nearplane' src={`${BASE_URL}typescriptnobg.png`} /></div>                            
                        </div>
                    </div>
                <div className='journey-rightbody-plane-con' >
                    <img className={`${Planeani} ${Rotateplane}`} id='planeimg' src={`${BASE_URL}planenobg.png`} />
                    <img className={`abs-circleofplane ${Planegas1} `} src={`${BASE_URL}circlenobg.png`} />
                    <img className={`abs-circleofplane ${Planegas2} `} src={`${BASE_URL}circlenobg.png`} />
                </div>
            </li>
        </ul>
        <br/>
