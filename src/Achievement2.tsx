export default function Achievement2(){
    ...
    <div className="ach-overall-con" >
            <div className="ach-1st-con" >
                ...
                <img className="ach-1st-img" src='/aiicert.jpg' ></img>
            ...
            <div className="ach-2st-con" >
                ...
                <img className="ach-2st-img" src='/publicspeakingcert.jpg' ></img>
            ...
            <div className="ach-3st-con" >
                ...
                <img className="ach-2st-img" src='/basiccomputer.jpg' ></img>
            ...
            <div className="ach-4st-con" >
                ...
                <img className="ach-4st-img" src='/khmergrade9.jpg' ></img>
                ...
                <img className="ach-4st-img" src='khmergrade12.jpg' ></img>
            </div>
        </div>
    </>)
}